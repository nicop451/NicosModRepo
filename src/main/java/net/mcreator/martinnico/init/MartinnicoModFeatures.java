...
import net.mcreator.martinnico.world.features.MoonShroomFeature;
...
public class MartinnicoModFeatures {
	private static final Map<Feature<?>, FeatureRegistration> REGISTRY = new HashMap<>();
	static {
		REGISTRY.put(MoonShroomFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.SURFACE_STRUCTURES,
				MoonShroomFeature.GENERATE_BIOMES, MoonShroomFeature.CONFIGURED_FEATURE));
	}
