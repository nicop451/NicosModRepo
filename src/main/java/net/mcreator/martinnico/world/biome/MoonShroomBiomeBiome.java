...
package net.mcreator.martinnico.world.biome;
...
import net.mcreator.martinnico.init.MartinnicoModBiomes;
import net.mcreator.martinnico.MartinnicoMod;

import java.util.Map;
import java.util.HashMap;

public class MoonShroomBiomeBiome {
	...
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-16645350).waterColor(-14703695).waterFogColor(-14703695)
				.skyColor(-16645350).foliageColorOverride(-14724687).grassColorOverride(-14724687)
	...
	public static void init() {
		Registry.register(BuiltinRegistries.CONFIGURED_SURFACE_BUILDER, new ResourceLocation(MartinnicoMod.MODID, "moon_shroom_biome"),
				SURFACE_BUILDER);
		CONFIGURED_FEATURES.forEach((resourceLocation, configuredFeature) -> Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, resourceLocation,
				configuredFeature));
		BiomeManager.addBiome(BiomeManager.BiomeType.WARM, new BiomeManager.BiomeEntry(
				ResourceKey.create(Registry.BIOME_REGISTRY, BuiltinRegistries.BIOME.getKey(MartinnicoModBiomes.MOON_SHROOM_BIOME)), 1014));
	}

	private static final Map<ResourceLocation, ConfiguredFeature<?, ?>> CONFIGURED_FEATURES = new HashMap<>();

	private static ConfiguredFeature<?, ?> register(String name, ConfiguredFeature<?, ?> configuredFeature) {
		CONFIGURED_FEATURES.put(new ResourceLocation(MartinnicoMod.MODID, name + "_moon_shroom_biome"), configuredFeature);
